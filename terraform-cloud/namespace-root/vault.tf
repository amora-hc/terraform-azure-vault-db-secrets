...
resource "vault_database_secret_backend_role" "mssql" {
  name     = var.vault_db_secrets_role
  backend  = vault_database_secrets_mount.db.path
  db_name  = var.vault_db_secrets_connection
